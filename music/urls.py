...
urlpatterns = [
    ...
    path('lyric_rating/<int:pk>/update/<int:fk>/', views.LyricRatingUpdate.as_view(), name='lyric_rating_update'),
    ...
    path('artist_rating/<int:pk>/update/<int:fk>/', views.ArtistRatingUpdate.as_view(), name='artist_rating_update'),
    ...
    path('song_rating/<int:pk>/update/<int:fk>/', views.SongRatingUpdate.as_view(), name='song_rating_update'),
